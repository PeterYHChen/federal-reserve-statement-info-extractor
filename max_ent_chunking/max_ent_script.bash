...
#java PROJECT_CHUNKER 2016_06.stmt-pos test_file_feature_vectors.txt
#java -classpath .:/mnt/c/computer_science/NLP/assignment_five/opennlp/output/* MEtrain me_train_input.txt metrain_output.txt
#java -cp .:/mnt/c/computer_science/NLP/assignment_five/opennlp/output/* MEtag_original test_file_feature_vectors.txt metrain_output.txt response_file_test.response
